...
public class ContextProvider
{
     ...
     */
    @Nullable
    public Context getContext(@NotNull Project project) throws MalformedURLException, VcsException, ContextProviderException {
        ...
        Integer caretPosition = editor.getCaretModel().getLogicalPosition().line;
