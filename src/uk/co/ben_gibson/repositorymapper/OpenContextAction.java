...
public class OpenContextAction extends AnAction
{
    ...
    public void actionPerformed(AnActionEvent event)
    {
        ...
        } catch (MalformedURLException | URISyntaxException | ContextProviderException |  UrlFactoryException | VcsException e) {
            e.printStackTrace();
        }
    }
    ...
    public void update(AnActionEvent event)
    {
        ...
        if (event.getProject() != null) {
            ...
            } catch (MalformedURLException | ContextProviderException | VcsException e) {
                e.printStackTrace();
            }
        }
